...
public class PopulateDatabase {
    static public void execute(Context context, PopulateCommand command) {
        ...
        country = new DbCountry("Czech Republic", "Prague", 50.083333, 14.466667, 10528477, 84, 208.872, 19796, "+420", ".cz", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_EUROPE, 78866, 117, 0, 4, "Koruna", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_czech_republic, R.drawable.map_czech_republic, CountryDifficulty.DIFFICULTY_HARD);
        ...
        tableCountry.addDbCountry(new DbCountry("Romania", "Bucharest", 44.416667, 26.1, 19942642, 59, 205.302, 10859, "+40", ".ro", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_EUROPE, 238391, 83, 696, 5, "Leu", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_romania, R.drawable.map_romania, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        country = new DbCountry("Sri Lanka", "Colombo", 6.933333, 79.833333, 20277597, 58, 70.966, 3385, "+94", ".lk", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 65610, 122, 2825, -1, "Rupee", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_sri_lanka, R.drawable.map_sri_lanka, CountryDifficulty.DIFFICULTY_EASY);
        ...
        // -- ASIA -- HARD
        tableCountry.addDbCountry(new DbCountry("Pakistan", "Islamabad", 33.666667, 73.166667, 196174380, 6, 243.818, 1307, "+99", ".xx", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 881912, 34, 2599, 4, "Rupee", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_pakistan, R.drawable.map_pakistan, CountryDifficulty.DIFFICULTY_HARD));
        ...
        tableCountry.addDbCountry(new DbCountry("Cambodia", "Phnom Penh", 11.55, 104.916667, 15405157, 70, 17.25, 1108, "+855", ".kh", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 181035, 90, 1127, 3, "Riel", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_cambodia, R.drawable.map_cambodia, CountryDifficulty.DIFFICULTY_HARD));
        tableCountry.addDbCountry(new DbCountry("Malaysia", "Kuala Lumpur", 3.133, 101.68, 30511900, 44, 800.169, 25833, "+60", ".my", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 330803, 68, 9323, 3, "Ringgit", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_malaysia, R.drawable.map_malaysia, CountryDifficulty.DIFFICULTY_HARD));
        ...
        tableCountry.addDbCountry(new DbCountry("Nepal", "Kathmandu", 27.7, 85.316667, 26494504, 47, 19.921, 743, "+977", ".np", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 147181, 95, 0, 2, "Rupee", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_nepal, R.drawable.map_nepal, CountryDifficulty.DIFFICULTY_HARD));
        ...
        tableCountry.addDbCountry(new DbCountry("North Korea", "Pyongyang", 39.033333, 125.75, 24895000, 49, 15.4, 621, "+850", ".kp", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 120540, 99, 4009, 3, "Won", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_north_korea, R.drawable.map_north_korea, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Saudi Arabia", "Riyadh", 24.65, 46.766667, 31521418, 41, 777.870, 25401, "+966", ".sa", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 2149690, 13, 7572, 7, "Riyal", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_saudi_arabia, R.drawable.map_saudi_arabia, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        tableCountry.addDbCountry(new DbCountry("Yemen", "Sana'a", 15.348333, 44.206389, 23833000, 50, 36.700, 1418, "+967", ".ye", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 527829, 50, 3149, 2, "Rial", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_yemen, R.drawable.map_yemen, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Syria", "Damascus", 33.5, 36.3, 23119262, 54, 59.957, 2802, "+963", "sy", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 185180, 89, 212, 5, "Pound", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_syria, R.drawable.map_syria, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Lebanon", "Beirut", 33.9, 35.533333, 4104000, 129, 47.497, 10530, "+961", ".lb", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 10452, 167, 294, 2, "Pound", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_lebanon, R.drawable.map_lebanon, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        tableCountry.addDbCountry(new DbCountry("Georgia", "Tbilisi", 41.716667, 44.783333, 4490500, 126, 15.984, 3596, "+995", ".ge", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 69700, 121, 376, 4, "Lari", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_georgia, R.drawable.map_georgia, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Kuwait", "Kuwait City", 29.366667, 47.966667, 3268431, 136, 173.438, 44585, "+965", ".kw", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 17820, 157, 756, 2, "Dinar", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_kuwait, R.drawable.map_kuwait, CountryDifficulty.DIFFICULTY_HARDER));

        // -- ASIA -- INSANE
        tableCountry.addDbCountry(new DbCountry("Uzbekistan", "Tashkent", 41.266667, 69.216667, 30492800, 45, 61.720, 2017, "+998", ".uz", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 447400, 57, 1707, 5, "Som", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_uzbekistan, R.drawable.map_uzbekistan, CountryDifficulty.DIFFICULTY_INSANE));
        tableCountry.addDbCountry(new DbCountry("Oman", "Muscat", 23.6, 58.55, 4146558, 128, 80.539, 21687, "+968", ".om", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_ASIA, 309501, 72, 2810, 3, "Rial", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_oman, R.drawable.map_oman, CountryDifficulty.DIFFICULTY_INSANE));
        ...
        tableCountry.addDbCountry(new DbCountry("Mozambique", "Maputo", -25.95, 32.583333, 25727911, 48, 14.600, 650, "+258", ".mz", Hemisphere.HEMISPHERE_SOUTH, Continent.CONTINENT_AFRICA, 801590, 36, 6942, 6, "Metical", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_mozambique, R.drawable.map_mozambique, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        tableCountry.addDbCountry(new DbCountry("Guatemala", "Guatemala City", 14.633333, -90.5, 15806675, 68, 49.880, 3302, "+502", ".gt", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_NORTH_AMERICA, 108889, 107, 445, 4, "Quetzal", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_guatemala, R.drawable.map_guatemala, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Haiti", "Port-au-Prince", 18.533333, -72.333333, 10911819, 82, 8.919, 852, "+509", ".ht", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_NORTH_AMERICA, 27750, 147, 1977, 1, "Gourde", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_haiti, R.drawable.map_haiti, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        tableCountry.addDbCountry(new DbCountry("Nicaragua", "Managua", 12.15, -86.266667, 6134270, 111, 11.848, 1921, "+505", ".ni", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_NORTH_AMERICA, 130375, 98, 1915, 2, "Córdoba", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_nicaragua, R.drawable.map_nicaragua, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        tableCountry.addDbCountry(new DbCountry("Peru", "Lima", -12.043333, -77.028333, 31151643, 42, 217.607, 6819, "+51", ".pe", Hemisphere.HEMISPHERE_SOUTH, Continent.CONTINENT_SOUTH_AMERICA, 1285216, 20, 3362, 5, "Nuevo sol", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_peru, R.drawable.map_peru, CountryDifficulty.DIFFICULTY_HARDER));
        ...
        tableCountry.addDbCountry(new DbCountry("Venezuela", "Caracas", 10.5, -66.966667, 30620404, 43, 209.226, 6869, "+58", ".ve", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_SOUTH_AMERICA, 916445, 33, 6762, 3, "Bolívar fuerte", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_venezuela, R.drawable.map_venezuela, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Suriname", "Paramaribo", 5.833333, -55.166667, 534189, 171, 5.273, 9539, "+597", ".sr", Hemisphere.HEMISPHERE_NORTH, Continent.CONTINENT_SOUTH_AMERICA, 163821, 92, 620, 2, "Dollar", DriveRoad.DRIVES_ON_RIGHT, R.raw.flag_suriname, R.drawable.map_suriname, CountryDifficulty.DIFFICULTY_INSANE));
        ...
        tableCountry.addDbCountry(new DbCountry("Vanuatu", "Port Vila", -17.75, 168.3, 264652, 187, 0.743, 3036, "+678", ".vu", Hemisphere.HEMISPHERE_SOUTH, Continent.CONTINENT_AUSTRALIA, 12190, 162, 3132, 0, "Vatu", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_vanuatu, R.drawable.map_vanuatu, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Samoa", "Apia", -13.833333, -171.75, 187820, 191, 0.630, 3451, "+685", ".ws", Hemisphere.HEMISPHERE_SOUTH, Continent.CONTINENT_AUSTRALIA, 2842, 178, 463, 0, "Tala", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_samoa, R.drawable.map_samoa, CountryDifficulty.DIFFICULTY_HARDER));
        tableCountry.addDbCountry(new DbCountry("Tonga", "Nukuʻalofa", -21.133333, -175.2, 103252, 201, 0.439, 4220, "+676", ".to", Hemisphere.HEMISPHERE_SOUTH, Continent.CONTINENT_AUSTRALIA, 748, 189, 909, 0, "Paʻanga", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_tonga, R.drawable.map_tonga, CountryDifficulty.DIFFICULTY_INSANE));
        tableCountry.addDbCountry(new DbCountry("Solomon Islands", "Honiara", -9.466667, 159.816667, 581344, 169, 0.840, 1553, "+677", ".sb", Hemisphere.HEMISPHERE_SOUTH, Continent.CONTINENT_AUSTRALIA, 28896, 143, 9880, 0, "Dollar", DriveRoad.DRIVES_ON_LEFT, R.raw.flag_solomon_islands, R.drawable.map_solomon_islands, CountryDifficulty.DIFFICULTY_INSANE));
